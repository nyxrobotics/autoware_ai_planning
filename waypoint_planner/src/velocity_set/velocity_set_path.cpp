                                           ...
                                           geometry_msgs::PoseStamped control_pose)
{
  ...
  local_waypoints_.header = updated_waypoints_.header;
  local_waypoints_.increment = updated_waypoints_.increment;
  ...
  for (int i = 0; i < local_waypoints_size; i++)
  {
    ...
    local_waypoints_.waypoints.push_back(updated_waypoints_.waypoints[closest_waypoint + i]);
  }
